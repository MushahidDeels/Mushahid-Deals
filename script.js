...
const products = [
    ...
    },
    {
        ...
        shortDescription: "Breathe easier with our advanced air purifier. Removes 99.97% of airborne particles including dust, pollen, and pet dander...",
        price: 179.99,
        oldPrice: 229.99,
        category: "home",
    ...
    },
    {
        ...
        shortDescription: "Experience crystal-clear sound with our premium wireless headphones. Featuring advanced noise cancellation technology...",
        price: 129.99,
        oldPrice: 199.99,
        category: "electronics",
    ...
    },
    {
        ...
        shortDescription: "Powerful 1500W blender with 8 preset programs for smoothies, soups, nut butters, and more. The durable stainless steel blades...",
        price: 149.99,
        oldPrice: 199.99,
        category: "home",
    ...
    },
    {
        ...
        shortDescription: "Eco-friendly yoga mat made from natural tree rubber. Extra thick 6mm cushioning provides joint support and comfort...",
        price: 49.99,
        oldPrice: 69.99,
        category: "health",
    ...
    },
    {
        ...
        shortDescription: "Luxurious designer handbag crafted from premium vegan leather. Spacious interior with multiple compartments for organization...",
        price: 89.99,
        oldPrice: 129.99,
        category: "fashion",
...
function initCopyLink() {
    document.querySelectorAll('.copy-link').forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            const productLink = `${window.location.origin}/product.html?id=${productId}`;
